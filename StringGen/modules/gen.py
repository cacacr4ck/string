...
async def gen_session(
    ...
    await message.reply_text(f"» Membuat {ty} Session Generator...")
    ...
    try:
        ...
        if telethon:
            ...
            await client(JoinChannelRequest("@storybangzul"))
        else:
